...
{
    /** A time style with no time-related components represented. If both the date style and time style are set to omitted, the time is represented using the default style of shortened. */
    case omitted = -1;
