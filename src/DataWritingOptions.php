...
class DataWritingOptions
{
    ...
    final const withoutOverwriting = 1 << 1;
    ...
    final const noFileProtection = 0x10000000;
    ...
    final const completeFileProtection = 0x20000000;
    ...
    final const completeFileProtectionUnlessOpen = 0x30000000;
}
