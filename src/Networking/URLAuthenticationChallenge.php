...
final class URLAuthenticationChallenge extends ObjectClass
{
     ...
     * @param URLCredential|null $proposedCredential The proposed credential, or null.
     ...
     * @param URLResponse|null $failureResponse An instance of URLResponse containing the server response that caused you to generate an authentication challenge, or null if no response object is applicable to the challenge.
     * @param Error|null $error An Error instance describing the authentication failure, or null if it is not applicable to the challenge.
