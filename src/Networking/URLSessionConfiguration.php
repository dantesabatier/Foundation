...
final class URLSessionConfiguration
{
    ...
    /** @var HTTPCookieStorage|null The cookie store for storing cookies within this session. This property determines the cookie storage object used by all tasks within sessions based on this configuration. To disable cookie storage, set this property to null. For default and background sessions, the default value is the shared cookie storage object. */
    public ?HTTPCookieStorage $httpCookieStorage = null;
    /** @var URLCache|null The URL cache for providing cached responses to requests within the session. This property determines the URL cache object used by tasks within sessions based on this configuration. To disable caching, set this property to null. For default sessions, the default value is the shared URL cache object. For background sessions, the default value is null. For ephemeral sessions, the default value is a private cache object that stores data in memory only and is destroyed when you invalidate the session. */
    public ?URLCache $urlCache = null;
    /** @var URLCredentialStorage|null A credential store that provides credentials for authentication. This property determines the credential storage object used by tasks within sessions based on this configuration. If you don't want to use a credential store, set this property to null. For default and background sessions, the default value is the shared credential store object. For ephemeral sessions, the default value is a private credential store object that stores data in memory only and is destroyed when you invalidate the session. */
    ...
    {
        return self::$default ??= new URLSessionConfiguration();
    }
