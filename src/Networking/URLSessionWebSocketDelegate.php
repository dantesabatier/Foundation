...
interface URLSessionWebSocketDelegate extends URLSessionTaskDelegate
{
     ...
     * 
     ...
     @param URLSessionWebSocketTaskCloseCode $closeCode The close code provided by the server. If the close frame didn't include a close code, this value is nil.
     @param string|null $reason The close reason provided by the server. If the close frame didn't include a reason, this value is nil.
     */
