...
final class EasyHandle
{
    ...
    public function urlErrorCode(int $easyCode): ?int
    {
        return match ($easyCode) {
            ...
            CURLE_RECV_ERROR, CURLE_SEND_ERROR, CURLE_PARTIAL_FILE, CURLE_FTP_ACCEPT_FAILED, CURLE_FTP_PORT_FAILED => URLErrorNetworkConnectionLost,
    ...
    private function setCookies(string $data): void
    {
        ...
        $headerComponents = explode(":", $data, 2);
