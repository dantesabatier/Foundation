...
final class UserDefaults
{
    ...
    public const string argumentDomain = ArgumentDomain;
    public const string globalDomain = GlobalDomain;
    public const string registrationDomain = RegistrationDomain;
