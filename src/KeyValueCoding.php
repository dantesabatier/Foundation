 ...
 *
 * The basic methods for accessing an object's values are {@see setValueForKey()}, which sets the value for the property identified by the specified key, and {@see valueForKey()}, which returns the value for the property identified by the specified key. Thus, all of an object's properties can be accessed consistently.
...
interface KeyValueCoding
{
     ...
     * @return mixed The value for the property identified by $key.
     */
     ...
     * The default implementation raises an {@see UndefinedKeyException}.
     * @param mixed $value The value for the key identified by $key.
     */
     ...
     * @param mixed $value A pointer to a new value for the property identified by $key.
