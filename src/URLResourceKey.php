...
{
    const string isApplicationKey = "isApplication";
    /** @var string Key for determining whether the resource is a directory (read-only). */
    const string isDirectoryKey = "isDirectory";
    ...
    const string parentDirectoryURLKey = "parentDirectory";
    /** @var string The resource's object type, returned as a string (read-only). */
    const string fileResourceTypeKey = "fileResourceType";
    ...
    const string isAliasFileKey = "isAliasFile";
    /** @var string The key for determining whether the resource is a file package. */
    const string isPackageKey = "isPackage";
    ...
    const string isRegularFileKey = "isRegularFile";
    ...
    const string attributeModificationDateKey = "attributeModificationDate";
    /** @var string The time at which the resource was created. */
    const string creationDateKey = "creationDate";
    ...
    const string isExecutableKey = "isExecutable";
    ...
    const string isHiddenKey = "isHidden";
    ...
    const string isWritableKey = "isWritable";
