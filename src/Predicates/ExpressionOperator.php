...
final class ExpressionOperator extends Expression
{
    ...
    public bool $isDeterministic {
        get => match ($this->operatorType) {
            ...
            ExpressionOperatorType::lpad,
            ExpressionOperatorType::rpad,
            ExpressionOperatorType::left,
            ExpressionOperatorType::right,
            ExpressionOperatorType::instr,
            ExpressionOperatorType::reverse,
            ExpressionOperatorType::repeat,
            ...
            ExpressionOperatorType::round,
            ExpressionOperatorType::coalesce,
            ExpressionOperatorType::greatest,
            ExpressionOperatorType::least,
            ExpressionOperatorType::quarter,
            ExpressionOperatorType::lastDay,
            ExpressionOperatorType::dayOfWeek,
            ExpressionOperatorType::dayOfYear,
            ExpressionOperatorType::fromUnixTime,
            ExpressionOperatorType::unixTimestamp,
            ExpressionOperatorType::addTime,
            ExpressionOperatorType::subTime,
