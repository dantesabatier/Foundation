...
class HTTPCookieStorage extends ObjectClass
{
    ...
    /** @internal */
    public static function ephemeral(): HTTPCookieStorage
    {
    ...
    {
        $this->setCookies($cookies, $task->request->url, $task->request->mainDocumentURL);
    }
    ...
    {
        $completionHandler($this->cookies($task->request->url));
    }
